# -*- coding: utf-8 -*-
"""
Created on Wed Jul 24 12:33:55 2024
...
# Nombre del archivo
file_path = 'flujo_canalizado_afores.xlsx'

# Datos de las hojas y sus descripciones
sheet_data = {
    "Hoja1": "Recursos Canalizados a las Afores",
    "Hoja2": "Ahorro Obligatorio",
    "Hoja3": "RCV",
    "Hoja4": "RCV IMSS",
    "Hoja5": "RCV ISSSTE",
    "Hoja6": "Vivienda",
    "Hoja7": "INFONAVIT",
    "Hoja8": "FOVISSSTE",
    "Hoja9": "Ahorro Voluntario y Solidario",
    "Hoja10": "Ahorro Voluntario",
    "Hoja11": "Ahorro Solidario"
...
Si tienes algún problema, asegúrate de que el archivo 'flujo_canalizado_afores.xlsx' esté en el directorio correcto.
""")
...
try:
    ...
    st.error("El archivo 'flujo_canalizado_afores.xlsx' no se encontró. Por favor, asegúrate de que el archivo esté en el directorio correcto.")
